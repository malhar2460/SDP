...
// },[handlePrediction]);
  ...
  return (
    <div className='bg-white min-h-screen'>
        ...
        <div className='flex items-center justify-between'>
          ...
          <div className='hidden sm:flex lg:flex-row gap-7'>
            ...
            <a onClick={toabout}>
              ...
              <a onClick={tosignup}>
                <button className='text-black  text-lg rounded-md   '>Sign up</button>
              </a>
          </div>
      ...
      {/* <p>{user}</p> */}
      <h1 className='text-4xl my-3  text-black font- font-serif'><span className=''>Sign Language Translator</span></h1>
        <div className='my-5 mt-7 mb-8'>
          ...
          <select value={selectedTimer} onChange={handleTimerChange} className='mx-5 border border-black px-1 py-[0.2%] rounded-md shadow-sm shadow-black'>
            <option value={1}>1 second</option>
            <option value={2}>2 seconds</option>
            <option value={3}>3 seconds</option>
          </select>
          <button onClick={() => setTimer(selectedTimer)} className='mx-5 text-black border border-white bg-white px-1 py-[0.2%] rounded-md hover:scale-110 shadow-sm shadow-black hover:shadow-md hover:shadow-black'>Click Photo</button>
          {timer > 0 && <p className='mt-4'>Timer: {timer}</p>}
        </div>
        <div className='flex flex-col xl:flex xl:flex-row md:flex md:flex-row gap-3 mx-[13.2%] '>
        ...
        <div className='mt-6  grid grid-flow-col w-96 ml-[13.5%]'>
          <div>
            {prediction && <p className='text-xl mr-96 w-max'><span className='outline outline-2 px-2 rounded-md'>Prediction</span> : {prediction}</p>}
          </div>
          <div>
            {sentence && <p className='text-xl ml-7 w-max'><span className='outline outline-2 px-2 rounded-md'>Sentence</span> :  {sentence}</p>}
          </div>
        </div>
    </div>
  );
